...
//
//        try {
//            var criteriaQuery = getCriteriaQueryByAttributes(entityManager, Dog_.owner, id);
//            transaction = entityManager.getTransaction();
//            transaction.begin();
//
//            var query = entityManager.createQuery(criteriaQuery);
...
//    }
    ...
    private CriteriaQuery<Dog> getCriteriaQueryByAttributes(EntityManager entityManager, SingularAttribute<Dog, ?> attribute, Object compareWith) {
        var criteriaBuilder = entityManager.getCriteriaBuilder();
        var criteriaQuery = criteriaBuilder.createQuery(Dog.class);
        var root = criteriaQuery.from(Dog.class);
